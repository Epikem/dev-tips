...
function createArray(lengths){
  var arr = new Array(lengths || 0), i = lengths;
...
function compress(input){
  ...
  return compressInternal(len, 0, 0);
  
  // return compressInternal(len, arr);
}

function compressInternal(len, y, x){
  var allsame = true;
  var comp = map[y][x];
  for(var r = 0; r < len;r++){
    for(var c = 0; c < len; c++){
  ...
  res += compressInternal(nlen,y,x);
  res += compressInternal(nlen,y,x+nlen);
  res += compressInternal(nlen,y+nlen,x);
  res += compressInternal(nlen,y+nlen,x+nlen) + ')';
  return res;
}
...
// const sinfo = jest.spyOn(global.console, 'info');
// const slog = jest.spyOn(global.console, 'log');
// const swarn = jest.spyOn(global.console, 'warn');
...
// 11110011`.split(`
// `);
// const ans1 = `((110(0101))(0010)1(0001))`
// const input2 =
//   `4
// 1111
// 0111
...
// 00111111`.split(`
// `);
// const ans3 = `(0(0011)(0(0111)01)1)`

// // test('template', ()=>{
// //   expect(Function()).toBe(ans);
// // })
...
// test('d1', () => {
//   expect(createArray(3)).toEqual(new Array(3));
// })
// test('d2', () => {
//   let arr = new Array(3).fill(0).map(() => new Array(4));
//   expect(createArray(3, 4)).toEqual(arr);
// })

// test('test1', () => {
//   expect(compress(input1)).toBe(ans1);
// })
// test('test2', () => {
//   expect(compress(input2)).toBe(ans2);
// })
// test('test3', () => {
//   expect(compress(input3)).toBe(ans3);
// })